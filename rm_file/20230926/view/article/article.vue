  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="标题" prop="titile" width="120" />
        ...
        <el-table-column align="left" label="操作">
          <template #default="scope">
            ...
            <el-button type="primary" link icon="edit" class="table-button"
              @click="updateArticleFunc(scope.row)">变更</el-button>
      ...
      <el-scrollbar height="500px">
        <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
          <el-form-item label="标题:" prop="titile">
            <el-input v-model="formData.titile" :clearable="true" placeholder="请输入标题" />
          </el-form-item>
